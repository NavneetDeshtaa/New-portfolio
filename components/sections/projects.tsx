...
const projects: Project[] = [
    {
        title: "DevDock- IDE",
        description: "Developed a fully functional web-based IDE with support for real-time code editing, project creation, deletion, and code download functionality, allowing users to code in up to 7 programming languages.Reduced project save/load time by 30% through optimized database queries, resulting in faster data retrieval.",
        techStack: ["Monaco-Editor","React", "Tailwind CSS", "File-Saver", "Morgan"],
    ...
    {
        title: "Photo- Lytics",
        description: "Created an AI-powered platform that translates textual descriptions into detailed images, achieving 90% positive feedback during initial testing.",
        techStack: ["Razorpay","Clip-drop API", "React", "TailwindCSS", "Bcrypt", ],
        images: ["/photolytics01.png", "/photolytics02.png"],
        liveUrl: "https://photo-lytics.vercel.app",
        gitUrl: "https://github.com/NavneetDeshtaa/PHOTO-LYTICS",
    },
    {
        title: "Chessverse -Backend Project",
        description: "Built a real-time multiplayer chess platform supporting two-player gameplay, featuring seamless turn-based interaction, robust game state updates, and sub-500ms latency.",
