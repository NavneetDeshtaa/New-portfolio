    ...
    return (
        <AnimatePresence mode="wait">
            <motion.div
                ...
                className={cn(
                    "flex max-w-max fixed top-5 inset-x-0 mx-auto border border-transparent dark:border-white/[0.2] rounded-xl shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-[5000] py-3 px-5 items-center justify-center space-x-4 backdrop-blur-sm bg-black/[0.5]",
                    className
                )}
            >
